...
Scene create_scene_dragon(int frame_number = 0) {
	Scene scene;
...
//	plymat.texture = new PPMTexture("input_files/texturesmarble2_texture.pnm");

	load_ply_into_scene(scene, "input_files/stanford/rozpak/dragon.ply", plymat,
		mat4.translation(vec3(0.0f, 10.0f, 16.0f))*
		mat4.rotation(vec3.X_AXIS, 0.1f)*
		mat4.rotation(vec3.Y_AXIS, 3.141592f - 0.6f)*
